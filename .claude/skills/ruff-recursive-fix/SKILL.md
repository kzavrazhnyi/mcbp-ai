...
виправити помилки ruff, запустити ruff, ruff автофікс, перевірка якості коду ruff, ruff check виправити всі помилки, ітеративно виправляти ruff, noqa виняток ruff, ruff format Python, виправити лінт помилки Python
